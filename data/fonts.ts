...
export const noticeTexts = {
  'en': {
    ...
    format: 'Format',
    formatDetail: '<font name><font style><region><font weight><italic>.css',
  ...
  'zh-cn': {
    ...
    explanation: '说明',
    format: '格式',
    formatDetail: '<字体名称><字体样式><地区><字重><斜体>.css',
    fontStyle: '字体样式',
    area: '地区',
    fontWeight: '字重',
    italic: '斜体',
  ...
  'zh-hk': {
    ...
    explanation: '說明',
    format: '格式',
    formatDetail: '<字體名稱><字體樣式><地區><字重><斜體>.css',
    fontStyle: '字體樣式',
    area: '地區',
    fontWeight: '字重',
    italic: '斜體',
  ...
  'jp': {
    ...
    explanation: '例証する',
    format: 'フォーマット',
    formatDetail: '<フォント名><フォント スタイル><地域><フォントの太さ><斜体>.css',
    fontStyle: 'フォント スタイル',
    area: '地域',
    fontWeight: 'フォントの太さ',
    italic: '斜体',
